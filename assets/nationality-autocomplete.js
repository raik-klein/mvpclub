(function($){
    $(function(){
        ...
        var container = $('<div class="mvpclub-autocomplete"></div>').css({position:'absolute', border:'1px solid #ccc', background:'#fff', 'z-index':1000, left:0, right:0}).appendTo(wrapper);
