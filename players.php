...
/**
 * Enqueue suggestion script for nationality field
 */
...
function mvpclub_player_admin_scripts($hook) {
    ...
    wp_enqueue_script(
        'mvpclub-nationality-suggestions',
        plugins_url('assets/nationality-suggestions.js', __FILE__),
        array('jquery'),
        filemtime(plugin_dir_path(__FILE__) . 'assets/nationality-suggestions.js'),
        true
    );

    wp_localize_script('mvpclub-nationality-suggestions', 'mvpclubPlayers', array(
        'countriesUrl' => plugins_url('assets/countries.json', __FILE__),
    ));

    wp_enqueue_style(
        'mvpclub-nationality-suggestions',
        plugins_url('assets/nationality-suggestions.css', __FILE__),
        array(),
        filemtime(plugin_dir_path(__FILE__) . 'assets/nationality-suggestions.css')
    );
}
